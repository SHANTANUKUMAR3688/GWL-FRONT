...
const Editemployeeupcomingoffer = () => {
    ...
    const { LManagerCustUpOffer } = location.state;
    ...
    const handlesubmit = async (e) => {
        ...
        try {
           await API.put(`/upcomingupdate-offer/${data.offerid}`, updateoffer, {
            ...
            const message = "offer not updated";
            toast.error(message);
            console.log(err);
        }
    };
    ...
    return (
        <div className="flex min-h-screen flex-col gap-y-4 p-4 sm:p-6">
            <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Edit Customer Upcoming Offers</h1>
